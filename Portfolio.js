...
const PROJECTS = [
  {
    ...
    github: 'https://github.com/gakshatb',
    images: [
...
form.addEventListener('submit',async e=>{
  ...
  try{
    ...
    if(SHEET_URL.includes('YOUR_SCRIPT_ID')){
      ...
      const resp=await fetch(SHEET_URL,{method:'POST',body:JSON.stringify(payload)});
      if(resp.ok||resp.type==='opaque'){form.reset();successMsg.style.display='flex';}
